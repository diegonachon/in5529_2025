...
#dblock(title: [Acknowledgment])[
  The following slides are based on the _Recommender Systems - An Introduction_ Teaching Material by Prof. Dietmar Jannach, 2011. #link("http://www.recommenderbook.net/")
]
...
- Example: A database of ratings of the current user, Alice, and some other users is given
  ...
  // #align(center)[
  //   #image("Chapters/Cap4/images/user-based-cf-example.png", width: 120mm)
  // ]
...
- Possible similarity values between $-1$ and $1$.
  ...
  // #align(center)[
  //   #image("Chapters/Cap4/images/user-based-cf-example-2.png", width: 120mm)
  // ]
...
- Takes differences in rating behavior into account
  ...
  // #align(center)[
  //   #image("Chapters/Cap4/images/user-based-cf-pearson.png", width: 80mm)
  // ]
...
- Example:
  ...
  // #align(center)[
  //   #image("Chapters/Cap4/images/item-based-example.png", width: 100mm)
  // ]
...
- Similarity is calculated based on the angle between the vectors
  ...
  $ "sim"(vec(a), vec(b)) = (vec(a) dot vec(b)) / (abs(vec(a)) * abs(vec(b))) $
...
- Adjusted cosine similarity
  ...
  // $ "sim"(vec(a), vec(b)) = frac(sum_(u in U)(r_(u,a) - overline(r)_u)(r_(u,b) - overline(r)_u)), (sqrt(sum_(u in U)(r_(u,a) - overline(r)_u)^2) sqrt(sum_(u in U)(r_(u,b) - overline(r)_u)^2))) $
...
// #align(center)[
//   #image("Chapters/Cap4/images/graph-cf-example.png", width: 35mm)
// ]
...
// #align(center)[
//   #image("Chapters/Cap4/images/graph-cf-example-2.png", width: 35mm)
// ]
...
// #align(center)[
//   #image("Chapters/Cap4/images/matrix-cf-example.png", width: 120mm)
// ]
...
#grid(
  ...
  // align(center)[
  //   #image("Chapters/Cap4/images/matrix-cf-example-2.png", width: 40mm)
  // ]
)
...
// #align(center)[
//   #image("Chapters/Cap4/images/matrix-cf-example-3.png", width: 110mm)
// ]
...
// - let $"freq"(X) = \{x | x subseteq t_i, t_i in D\}$
...
#grid(
  ...
  // align(center)[
  //   #image("Chapters/Cap4/images/association-rule-cf-example.png", width: 45mm)
  // ]
)
...
// #align(center)[
//   #image("Chapters/Cap4/images/probabilistic-cf-example.png", width: 115mm)
// ]
...
- Example:
  ...
  // #image("Chapters/Cap4/images/rf-rec-cf-example.png", width: 70mm)
